...
<style>
  body {
    ...
    background: url('./image/Automated students attendance systems.jpg') center/cover no-repeat;
    /* Replace 'background-image.jpg' with your image path */
    /* background-color: #FFFFFF; /* red fallback */
    color: #FFFF00; /* red */
...
<div class="overlay">
  <div class="container">
    ...
    <p><i>AUTOMATED  STUDENTS ATTENDANCE SYSTEM</i></p>
